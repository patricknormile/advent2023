data = """...788.............................54.........501...........555.........270.................................521......893....................
...
def make_string_array(string) : 
    ...
    len0 = len(array[0])
    assert all(map(lambda x : len(x) == len0, array))
    return array

def find_numbers_in_row(idx) :
    ...
    for i, r in enumerate(row) : 
        if r == "." : 
            continue
        if r in digits : 
            ids_with_numbers.append(i)
            numbers_collected.append(r)
    
    k = 0
    number_places = {}
    last_j = ids_with_numbers[0]
    for j, (i, n) in enumerate(zip(ids_with_numbers[1:], numbers_collected[1:]),1) : 
        if i != ids_with_numbers[j-1] + 1 :
            number_places[k] = {'start':last_j,
                                'stop': ids_with_numbers[j-1],
                                'numbers' : row[last_j:ids_with_numbers[j-1]+1]}
            last_j = i
            k += 1
        elif i == max(ids_with_numbers) :
            number_places[k] = {'start':last_j,
